...
Here's how I would use grep to solve Wordle. I'm on macOS so my grep doesn't have look-ahead or look-behind (I think the gnu version does--yeah I could install it with brew, I just haven't done it).
